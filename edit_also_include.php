...
if($result){
		echo"<script> window.location = 'http://localhost/file_management/all_also_includes.php';</script>";
	}
	else{
		echo"<script> window.location = 'http://localhost/file_management/edit_also_include.php';</script>";
	}
